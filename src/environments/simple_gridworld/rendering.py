...
from .simple_gridworld import GridworldEnvState
...
class Viewer(object):
    ...
    def render(self, env_state: GridworldEnvState, return_rgb_array=False):
        ...
        self._draw_grid()
        self._draw_agent(env_state)
        self._draw_goal(env_state)
    ...
    def _draw_goal(self, env_state: GridworldEnvState):
    ...
    def _draw_agent(self, env_state: GridworldEnvState):
